...
def reset:
    ...
    _const12 = (0x02000000 >> 24) & 0x3ff, dx = DXCONST
    _const12 = (0x02000000 >> 12) & 0x3ff, dx = DXCONST
    _const12 = (0x02000000 >> 00) & 0x3ff, dx = DXCONST
    # Q contains address 0x25, the reset vector
    _const12 = (0x00000025 >> 24) & 0x3ff, qx = QXCONST
    _const12 = (0x00000025 >> 12) & 0x3ff, qx = QXCONST
    _const12 = (0x00000025 >> 00) & 0x3ff, qx = QXCONST
